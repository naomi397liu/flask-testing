...
class PartyTests(unittest.TestCase):
    ...
    def test_no_rsvp_yet(self):
        ...
        # party details
        result = self.client.get("/")
        self.assertIn(b"<h2>Please RSVP</h2>", result.data) #doesn't like
        self.assertIsNot(b"yay", result.data) #this works with b"yay" and <h2>
        # print("FIXME")
    ...
    def test_rsvp(self):
        ...
        # not the RSVP form
        self.assertIsNot(b"<h2>Please RSVP</h2>", result.data) #doesn't like
...
class PartyTestsDatabase(unittest.TestCase):
    ...
    def test_games(self):
        ...
        self.assertIn(b"chess", result.data)
        # print("FIXME")
